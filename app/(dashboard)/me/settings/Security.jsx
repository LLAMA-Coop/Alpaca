...
export function Security({ user }) {
    ...
    return (
        <section className={styles.content}>
            ...
            <InfoBox>
                {twoFactorEnabled ? (
                    ...
                    <>
                        ...
                        authentication. Two-factor authentication adds an extra layer of security to
                        your account by requiring a second step of verification when you sign in.
                        This helps prevent unauthorized access to your account, even if your
            ...
            <div>
                ...
                >
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Are you sure you want to disable 2 Factor Authentication? You will no
                            longer need to enter a verification code when you sign in.
                        </DialogDescription>
                        ...
                        <div className={styles.totp}>
                            {!codes.length ? (
                                <>
                                    ...
                                    <p>
                                        After scanning the QR code, enter the code generated by your
                                ...
                                <>
                                    ...
                                    <p>
                                        ...
                                        authenticate in case you lose access to your authenticator
                                        app. We recommend saving these codes in a secure place.
                                    </p>

                                    <InfoBox type="warning">
                                        Keep these codes safe. If you lose your device and you don't
                                        have the recovery codes, you will lose access to your
                                        account.
                                    </InfoBox>
                                    ...
                                    <DialogButtons>
                                        <button
                                            disabled={(!hasCopied || loading) && !twoFactorEnabled}
                                            className="button success"
                                            onClick={() => {
                                                if (twoFactorEnabled) {
            ...
            <p>
                Manage your active sessions. If you see a session you don't recognize, you can log
                out of that session.
            </p>
                ...
                <>
                    <ul>
                        {user.sessions.map((session) => (
                            ...
                            >
                                <aside>{deviceIcons[session.device] || deviceIcons.Unknown}</aside>
