...
export async function catchRouteError({ error, route }) {
        ...
        const sources = await db
            ...
            .where(({ eb, or }) =>
                or([
                    eb("createdBy", "=", userId),
                    eb("readAll", "=", 1),
                    eb(sql`JSON_CONTAINS(read, '${userId}', '$')`),
                ]),
            )
            .execute();
...
export async function getPermittedSources(userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedSources" });
        return [];
    }
}
...
export async function getPermittedSource(sourceId, userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedSource" });
        return {};
    }
}
...
export async function getSourcesById({ id, ids, userId }) {
  ...
  `;
    ...
    try {
        ...
        catchRouteError({ error, route: "getSourcesById" });
        return [];
    }
}
...
export async function updateSource(source) {
    ...
    try {
        ...
        catchRouteError({ error, route: "updateSource" });
        throw error;
    }
}
...
`;
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedNotes" });
        return [];
    }
}
...
export async function getPermittedNote(noteId, userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedNote" });
        return {};
    }
}
...
export async function getNotesById({ id, ids, userId }) {
  ...
  `;
    ...
    try {
        ...
        catchRouteError({ error, route: "getNotesById" });
        return [];
    }
}
...
export async function updateNote(note) {
    ...
    try {
        ...
        catchRouteError({ error, route: "updateNote" });
        throw error;
    }
}
...
export async function upsertTable(tableName, data, updateColumns) {
    try {
        ...
        catchRouteError({ error, route: "upsertTable" });
        throw error;
    }
}
...
export async function getPermittedQuizzes(userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedQuizzes" });
        return [];
    }
}
...
export async function getUserQuizzes(userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getUserQuizzes" });
        return [];
    }
}
...
export async function updateQuiz(quiz) {
    ...
    try {
        ...
        catchRouteError({ error, route: "updateQuiz" });
        throw error;
    }
}
...
`;
    ...
    try {
        ...
        catchRouteError({ error, route: "getQuizzesById" });
        return [];
    }
}
...
export async function getPermittedCourses(userId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getPermittedCourses" });
        return [];
    }
}
...
export async function updateCourse(course) {
    ...
    try {
        ...
        catchRouteError({ error, route: "updateCourse" });
        throw error;
    }
}
...
export async function getUserGroups(userId) {
    ...
    LEFT JOIN \`ResourcePermissions\`
        ON \`ResourcePermissions\`.\`resourceId\` = \`Groups\`.\`id\`
        AND \`ResourcePermissions\`.\`resourceType\` = 'group
    ...
    try {
        ...
        catchRouteError({ error, route: "getUserGroups" });
        return [];
    }
}
...
export async function insertPermissions(permissions, resourceId, permittedId) {
    ...
    try {
        ...
        catchRouteError({ error, route: "insertPermissions" });
        return {};
    }
}
...
export async function updatePermissions(permissions) {
    try {
        ...
        catchRouteError({ error, route: "updatePermissions" });
        throw error;
    }
}
...
export async function getGroup({ id, userId }) {
    ...
    try {
        ...
        catchRouteError({ error, route: "getGroup" });
        return {};
    }
}
