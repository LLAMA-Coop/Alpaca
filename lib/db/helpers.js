    ...
    return eb
      ...
      .select(({ eb }) => {
        ...
        if (type !== "source") {
          ...
          //   as: "rr",
          //   columns: sourceDefaultColumns,
          //   join: `INNER JOIN sources as s ON rr.A = s.id`,
          //   asJoin: "s",
          ...
          //   as: "rr",
          //   columns: sourceDefaultColumns,
          //   join: `INNER JOIN sources as s1 ON rr.A = s1.id`,
          //   asJoin: `s1`,
          //   condition: `rr.B = ${as}.id AND rr.B_type = "${type}" AND rr.A_type = "source"`,
          //   multiple: true,
          // });
        }
        ...
        //     as: "rr",
        //     columns: noteDefaultColumns,
        //     join: `INNER JOIN notes as n1 ON rr.A = n1.id`,
        //     asJoin: "n1",
        //     condition: `rr.B = ${as}.id AND rr.B_type = "${type}" AND rr.A_type = "note"`,
        //     multiple: true,
        //   });
        ...
        if (type === "quiz") {
          ...
          //   as: "rr",
          //   columns: noteDefaultColumns,
          //   join: `INNER JOIN notes as n ON rr.A = n.id`,
          //   asJoin: "n",
          //   condition: `rr.A = ${as}.id AND rr.A_type = "${type}" AND rr.B_type = "note"`,
          //   multiple: true,
          // });
