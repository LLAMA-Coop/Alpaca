...
export async function getSourcesById({ id, ids, userId }) {
  ...
  `;
    ...
    try {
        ...
        // console.log("RESULTS SOURCES", sources);
        return sources;
    } catch (error) {
        console.error(error);
    }
...
export async function getNotesById({ id, ids, userId }) {
  ...
  `;
    ...
    try {
        ...
        console.log("RESULTS NOTES", notes);
        return notes;
    } catch (error) {
        console.error(error);
    }
...
export async function getPermittedQuizzes(userId) {
    ...
    try {
        ...
        //         permittedId: x.permittedId,
        //         permittedType: x.permittedType,
        ...
        quizResults.forEach((q) => {
            ...
            if (
                ...
                if (quiz.permissionType !== "write") {
                    ...
                    if (
                        q.permittedType === "user" &&
                        q.permittedId === userId
                    ) {
                        quiz.permissionType = q.permissionType;
                    }
                    if (
