// import numberEquivalents from "./numberEquivalents";
...
//     if (!isNaN(a) && numberEquivalents[a]) {
//         a = numberEquivalents[a];
//     }

//     if (!isNaN(b) && numberEquivalents[b]) {
//         b = numberEquivalents[b];
//     }

//     a = typeof a === "string" ? a.trim().toUpperCase() : a;
//     b = typeof b === "string" ? b.trim().toUpperCase() : b;
...
export function stringCompare(str1, str2) {
  ...
  if (typeof str1 !== "string" || typeof str2 !== "string") {
    throw Error(
      `stringCompare cannot compare values that are not strings: ${str1.toString()}, ${str2.toString()}`
    );
  }
  return levenshtein(str1.trim().toLowerCase(), str2.trim().toLowerCase())
    .similarity;
}
